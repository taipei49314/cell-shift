...
Failure atlas: [T2.md](T2.md). Chamber is **maintenance-only**.

This repo is a **public subject** of the
[Nelson audit spine](https://github.com/taipei49314/nelson-stack), not the
flagship. Frozen journey: [JOURNEY.md](JOURNEY.md). The chamber's own
`npm test` is not the spine verdict.
